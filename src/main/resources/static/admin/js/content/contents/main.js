var app = new Vue({
	...
	methods: {
		...
		fnDetail(obj) {
			document.location.href = '/admin/content/contents/' + obj.contentId;
		},

		fnUpdate(obj) {
			document.location.href = '/admin/content/contents/register?contentId=' + obj.contentId;
		},
		...
		fnDelete(obj) {
			...
			modalView.openConfirm(
				'삭제 하시겠습니까?',
				function(){
					axios.delete('/admin/api/v1/contents/' + obj.contentId)
					.then(function(response) {
